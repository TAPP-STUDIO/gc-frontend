...
export const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Discord',
      href: 'https://discord.gg/tcvTy6y5',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/gavlikcapital/',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'X (Twitter)',
      href: 'https://x.com/GavlikCapital',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Směnárna',
      href: 'https://gcex.cz/?fbclid=PAZXh0bgNhZW0CMTEAAaeQKU39QAT086aALlPQ0ySo5Cm1_fQ6tCl5lfEYIXvGbkBmhjhQwDomNTbHLw_aem_XapkCV480m14xIwnFfD3rw',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('/backgrounds/footer.svg')",
