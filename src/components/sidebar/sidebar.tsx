                ...
                {navItems.map(item => (
                  <li key={item.id} className="relative">
                    <div className="flex items-center mb-2">
                      {/* Hlavní link/tlačítko pro portfolio */}
                    ...
                    {item.id === 'portfolio' && portfolioItems.length > 0 && (
                      <div
                        ...
                        style={{
                          maxHeight: isExpanded(item.id) ? `${portfolioItems.length * 40 + 20}px` : '0px'
                        }}
                      >
            ...
            <div className="mt-auto pb-4 border-t border-[#333333] pt-4">
              <div className="space-y-3 mb-4">
                ...
                >
                  ...
                  <span className="text-sm">Dokumentace</span>
                </a>
              </div>
            </div>
          </div>
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-30 p-2 bg-[#151515] text-white hover:text-[#F9D523] transition-colors lg:hidden border border-[#333333] rounded-md"
      ...
      {/* Desktop sidebar */}
      <aside 
        className={`hidden lg:flex flex-col h-screen bg-[#151515] border-r border-[#333333] transition-all duration-300 ease-in-out overflow-hidden relative ${
                ...
                <li key={item.id} className="relative group">
                  <div className={`${isCollapsed ? 'flex justify-center' : 'flex items-center mb-2'}`}>
                    ...
                    {item.id === 'portfolio' && portfolioItems.length > 0 && !isCollapsed ? (
                      // Portfolio s rozbalením - celý řádek je klikatelný
                      <button
                        onClick={(e) => {
                          e.preventDefault();
                          toggleItemExpansion(item.id, e);
          ...
          <div className={`mt-auto pb-4 border-t border-[#333333] pt-4 ${isCollapsed ? 'px-1' : 'px-0'}`}>
            ...
            <div className={`space-y-3 mb-4 ${isCollapsed ? 'space-y-2' : ''}`}>
              ...
              <a
                ...
                title={isCollapsed ? "Podpora" : undefined}
              >
                ...
                {!isCollapsed && <span className="text-sm">Podpora</span>}
              ...
              <a
                ...
                title={isCollapsed ? "Dokumentace" : undefined}
              >
                <span className={`w-5 h-5 flex items-center justify-center ${!isCollapsed ? 'mr-3' : ''}`}>
                  <svg 
                    width="20" 
                ...
                {!isCollapsed && <span className="text-sm">Dokumentace</span>}
